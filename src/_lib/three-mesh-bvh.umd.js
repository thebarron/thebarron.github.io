// ═══════════════════════════════════════════════════════════════════════
// three-mesh-bvh — VENDORED (unified collision rebuild, 2026-07-04)
// ═══════════════════════════════════════════════════════════════════════
// Version: 0.9.10  (npm three-mesh-bvh@0.9.10, build/index.umd.cjs verbatim)
// License: MIT (Garrett Johnson / gkjohnson). Peer dep: three >= 0.159.0 (we run r183).
//
// BINDING: the UMD browser branch calls factory(global.MeshBVHLib, global.THREE).
//   Our three.webgpu.global.js declares `var THREE` at top-level script scope →
//   window.THREE === globalThis.THREE, so global.THREE resolves with NO shim needed.
//   Exports land on window.MeshBVHLib ({ MeshBVH, ... }). collision_world.js reads it.
//   Load order: AFTER three.webgpu.global.js, BEFORE the module bundle (shell.html tag).
//
// DO NOT EDIT — regenerate via `npm pack three-mesh-bvh@<ver>` in the scratchpad and
// re-prepend this header. No runtime network fetch; fully offline.
// ═══════════════════════════════════════════════════════════════════════
